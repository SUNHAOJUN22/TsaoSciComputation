...
coverage_test = ROOT / "tests/test_adversarial_phase_a_coverage.py"
...
if text.count(old) != 1:
    raise SystemExit("runtime-template readiness assertion not found exactly once")
coverage_test.write_text(text.replace(old, new, 1), encoding="utf-8", newline="\n")

print("final Phase A deterministic corrections applied")
